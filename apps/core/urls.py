...
from apps.core.views import save_chore, delete_chore, create_location, create_equipment, create_task, delete_location, save_location, location_detail_json, save_equipment, delete_equipment, equipment_detail_json
...
urlpatterns = [
    ...
    path('chores/equipment/save/', save_equipment, name='save_equipment'),
    path('chores/equipment/delete/<int:equipment_id>/', delete_equipment, name='delete_equipment'),
    path('chores/equipment/<int:equipment_id>/json/', equipment_detail_json, name='equipment_detail_json'),
